...
export declare enum XboxLiveDomains {
...
export declare type PlayerSettings = ('GameDisplayPicRaw' | 'Gamerscore' | 'Gamertag' | 'AccountTier' | 'XboxOneRep' | 'PreferredColor' | 'RealName' | 'Bio' | 'Location')[];
...
export declare type PlayerSettingsResponse = {
    id: string;
    value: string;
}[];
export declare type PlayerXUIDResponse = string;
export declare type PlayerGamertag = string;
export declare type HTTPMethod = 'GET' | 'PATCH' | 'POST' | 'PUT' | 'DELETE';
